...
class Window(QMainWindow):
    ...
    def _createMenu(self):
        ...
        self.replace_action = QAction(QIcon(":/icons/replace.png"), "Re&place...", self)
        ...
        self.toolbar_action = QAction(QIcon(":/icons/toolbar.png"), "&Toolbar", self)
        ...
        self.statusbar_action = QAction(QIcon(":/icons/statusbar.png"), "&Status Bar", self)
        ...
        self.filelist_action = QAction(QIcon(":/icons/file_list.png"), "&File List", self)
        ...
        self.hash_calc_action = QAction(QIcon(":/icons/hash_calc.png"), "&Hash Calculator", self)
        ...
        self.disk_imager_action = QAction(QIcon(":/icons/disk_imager.png"), "&Disk Imager", self)
        ...
        self.options_action = QAction(QIcon(":/icons/options.png"), "&Options...", self)
        ...
        self.about_action = QAction(QIcon(":/icons/about.png"), "&About ByteProbe", self)
